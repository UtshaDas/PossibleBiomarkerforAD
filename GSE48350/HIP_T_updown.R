...
data <- read.csv("F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE48350/HIP_T_UpDown.csv", row.names=1)
...
for (i in 1:nrow(data)){
  vec1 = as.numeric(data[i:i,1:43])
  vec2 = as.numeric(data[i:i,44:62])
...
write.csv(resUp, file="F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE48350/HIP_T_upregulated.csv")
write.csv(resDown, file="F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE48350/HIP_T_downregulated.csv")
