...
data <- read.csv("F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE48350/HIPData.csv", row.names=1)
...
write.csv(res, file="F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE48350/HIP_T_hochberg_result_all.csv")
write.csv(res2, file="F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE48350/HIP_T_hochberg_result.csv")
