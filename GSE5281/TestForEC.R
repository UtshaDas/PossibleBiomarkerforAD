...
data <- read.csv("F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE5281/ECData.csv", row.names=1)
...
write.csv(res, file="F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE5281/EC_T_hochberg01_result_all.csv")
write.csv(res2, file="F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE5281/EC_T_hochberg01_result.csv")
