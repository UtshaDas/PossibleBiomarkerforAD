...
data <- read.csv("F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE5281/EC_T_UpDown.csv", row.names=1)
...
write.csv(resUp, file="F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE5281/EC_T_upregulated.csv")
write.csv(resDown, file="F:/Thesis/AlzheimersDisease/UtshaDas/AlzheimersDisease1/Dataset/GSE5281/EC_T_downregulated.csv")
